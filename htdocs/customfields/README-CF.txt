...
*				version	2.27 (branch v2)		  *
*	    for Dolibarr >= 3.4.0 (3.5.x included)    *
...
/htdocs/core/modules/substitutions/functions_customfields.lib.php --- CustomFields substitution class for ODT generation : necessary to support customfields tags in ODT files

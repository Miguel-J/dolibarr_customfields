...
$cfversion = '3.5.15'; // version of this module, useful for other modules to discriminate what version of CustomFields you are using (may be useful in case of newer features that are necessary for other modules to properly run)
...
$sql_datatypes = array( 'varchar' => $langs->trans("Textbox"),
                                             ...
                                             'decimal' => $langs->trans("Decimal"),
                                             'numeric' => $langs->trans("Numeric"),
